<?php
/**
 * Public Event Staffing Report.
 *
 * Available to any logged-in user. Shows who is staffing each function
 * and time period, displaying only the person's name.
 */
...
// Fetch all upcoming events for the dropdown (plus the selected event if past)
...
// Build staffing data for the selected event
$reportData   = [];
$totalSignups = 0;
$totalSlots   = 0;
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="mb-0">Event Staffing</h1>
    <?php if ($event): ?>
...
<div class="card shadow-sm mb-4">
    <div class="card-body">
        <form method="get" action="staffing.php" class="row g-2 align-items-end">
            <div class="col-md-8">
            ...
            <div class="col-md-4">
                <button type="submit" class="btn btn-primary">View Staffing</button>
            </div>
        </form>
    </div>
</div>
                        ...
                        <?php foreach ($fnBlock['periods'] as $pBlock): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <?= htmlspecialchars(implode(', ', array_column($names, 'name'))) ?>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>

...
<h1 class="mb-4">My Signups</h1>

<?php if ($success === 'cancel'): ?>
    <div class="alert alert-info alert-dismissible fade show">Signup cancelled successfully.<button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>
<?php endif; ?>

<?php if (empty($signups)): ?>
    <div class="card shadow-sm">
        <div class="card-body">
            <p class="text-muted text-center mb-0">You have no signups yet. <a href="events.php">Browse events</a> to get started.</p>
        </div>
    </div>
<?php else: ?>
    <div class="card shadow-sm">
                ...
                <table class="table table-striped table-hover align-middle mb-0">
                    ...
                    <?php foreach ($signups as $s): ?>
                        ...
                        <tr>
                            ...
                            <td><small><?= date('M j, Y g:i A', strtotime($s['signed_up_at'])) ?></small></td>
                            <td>
                                <?php if ($isPast): ?>
